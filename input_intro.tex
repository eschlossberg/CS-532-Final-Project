...
Although this is not a compulsory proceduce, but converting non-numerical companies label to numerical labels through \emph{LabelEncoder} can ease us in feeding the matrix to learning model later.
